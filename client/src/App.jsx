...
const mapLead = useCallback(l => ({
  ...
  xbaDate:l.xba_date?(v=>v instanceof Date?v:new Date(v))(l.xba_date).toISOString().slice(0,10):null,
  q1Date:l.q1_date?(v=>v instanceof Date?v:new Date(v))(l.q1_date).toISOString().slice(0,10):null,
  ...
  vizaSana:l.visa_date?String(l.visa_date).slice(0,10):"",
