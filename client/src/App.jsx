...
const mapLead = useCallback(l => ({
  ...
  kpiSalesDate:l.kpi_sales_date||null,
  kpiConsultDate:l.kpi_consult_date||null,
  kpiDocsDate:l.kpi_docs_date||null,
  kpiSalesReceipt:l.kpi_sales_receipt||null,
  kpiConsultReceipt:l.kpi_consult_receipt||null,
  kpiDocsReceipt:l.kpi_docs_receipt||null,
...
const saveLead = useCallback(async f => {
    ...
    try {
      const savedRow = await leadsAPI.save({
        ...
        kpiDocs:f.kpiDocs,
        kpiSalesDate:f.kpiSalesDate||null,
        kpiConsultDate:f.kpiConsultDate||null,
        kpiDocsDate:f.kpiDocsDate||null,
        kpiSalesReceipt:f.kpiSalesReceipt||null,
        kpiConsultReceipt:f.kpiConsultReceipt||null,
        kpiDocsReceipt:f.kpiDocsReceipt||null,
