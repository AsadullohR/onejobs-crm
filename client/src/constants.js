...
const INIT_ROLES = {
  ...
  sales:   {label:"Sotuv/Call", color:"#f97316",canOwner:true, canFin:false,canSalary:false,canEdit:true, canCfg:false,canTeam:false, seeAll:true, canTakeUnassigned:true, canChangeOwner:true},
